...
var opMap,
  FontInspector = (function () {
    ...
    function i(e, t) {
      ...
      for (let e of n) e.className = t ? 'debuggerShowText' : 'debuggerHideText';
    }
    function o(e) {
      if (e.target.dataset.fontName && 'SPAN' === e.target.tagName.toUpperCase())
        for (var t = e.target.dataset.fontName, n = document.getElementsByTagName('input'), a = 0; a < n.length; ++a) {
          var r = n[a];
          r.dataset.fontName === t && ((r.checked = !r.checked), i(t, r.checked), r.scrollIntoView());
        }
    }
    return {
      id: 'FontInspector',
      ...
      fontAdded: function (n, a) {
        var o = (function (e, t) {
            for (var n = document.createElement('table'), a = 0; a < t.length; a++) {
              var r = document.createElement('tr'),
                i = document.createElement('td');
              (i.textContent = t[a]), r.appendChild(i);
              var o = document.createElement('td');
              (o.textContent = e[t[a]].toString()), r.appendChild(o), n.appendChild(r);
            }
            return n;
          })(n, ['name', 'type']),
          d = n.loadedName,
        ...
        a ? ((a = /url\(['"]?([^\)"']+)/.exec(a)), (p.href = a[1])) : n.data && (p.href = t(n.data, n.mimeType)),
  ...
  StepperManager = (function () {
    ...
    return {
      ...
      init: function (e) {
        var i = this;
        for (var o in (this.panel.setAttribute('style', 'padding: 5px;'),
        (n = document.createElement('div')),
        (a = document.createElement('select')).addEventListener('change', function (e) {
        ...
        sessionStorage.getItem('pdfjsBreakPoints') && (r = JSON.parse(sessionStorage.getItem('pdfjsBreakPoints'))),
      ...
      selectStepper: function (t, n) {
        var r;
        for (t |= 0, n && this.manager.selectPanel(this), r = 0; r < e.length; ++r) {
          var i = e[r];
          i.pageIndex === t ? i.panel.removeAttribute('hidden') : i.panel.setAttribute('hidden', !0);
        }
        var o = a.options;
      ...
      saveBreakPoints: function (e, t) {
        (r[e] = t), sessionStorage.setItem('pdfjsBreakPoints', JSON.stringify(r));
      },
    };
  })(),
  Stepper = (function () {
      ...
      (n.prototype = {
        ...
        updateOperatorList: function (n) {
          ...
          function r() {
            ...
            this.checked ? a.breakPoints.push(e) : a.breakPoints.splice(a.breakPoints.indexOf(e), 1),
              StepperManager.saveBreakPoints(a.pageIndex, a.breakPoints);
          }
          if (!(this.operatorListIdx > 15e3)) {
            for (
              var i = document.createDocumentFragment(), o = Math.min(15e3, n.fnArray.length), d = this.operatorListIdx;
              d < o;
              d++
            ) {
              var l = e('tr');
              ...
              var h = opMap[n.fnArray[d]],
                m = p;
              if ('showText' === h) {
                for (var v = p[0], f = [], g = [], C = 0; C < v.length; C++) {
                  var b = v[C];
                  'object' == typeof b && null !== b
                    ? g.push(b.fontChar)
                    : (g.length > 0 && (f.push(g.join('')), (g = [])), f.push(b));
                }
                g.length > 0 && f.push(g.join('')), (m = [f]);
              }
              l.appendChild(e('td', h)), l.appendChild(e('td', JSON.stringify(t(m))));
            }
            ...
            (this.operatorListIdx = n.fnArray.length), this.table.appendChild(i);
          }
        },
        getNextBreakPoint: function () {
          ...
          for (var e = 0; e < this.breakPoints.length; e++)
            if (this.breakPoints[e] > this.currentIdx) return this.breakPoints[e];
          return null;
        },
        breakIt: function (e, t) {
          ...
          var r = function (e) {
            switch (e.keyCode) {
              case 83:
                a.removeEventListener('keydown', r), (n.nextBreakPoint = n.currentIdx + 1), n.goTo(-1), t();
                break;
              case 67:
        ...
        goTo: function (e) {
          for (var t = this.panel.getElementsByClassName('line'), n = 0, a = t.length; n < a; ++n) {
            var r = t[n];
            (0 | r.dataset.idx) === e
              ? ((r.style.backgroundColor = 'rgb(251,250,207)'), r.scrollIntoView())
  ...
  Stats = (function () {
    ...
    return {
      ...
      add(n, a) {
        if (a) {
          var r = (function (t) {
            for (var n = 0, a = e.length; n < a; ++n) if (e[n].pageNumber === t) return n;
            return !1;
          })(n);
          if (!1 !== r) {
            var i = e[r];
          ...
          (l.textContent = a.toString()),
            ...
            t(this.panel);
          for (var s = 0, p = e.length; s < p; ++s) this.panel.appendChild(e[s].div);
        }
      },
      cleanup() {
        (e = []), t(this.panel);
...
window.PDFBug = (function () {
  ...
  return {
    ...
    cleanup() {
      for (var e = 0, t = this.tools.length; e < t; e++) this.tools[e].enabled && this.tools[e].cleanup();
    },
    selectPanel(n) {
      if (('number' != typeof n && (n = this.tools.indexOf(n)), n !== t)) {
        ...
        for (var a = this.tools, r = 0; r < a.length; ++r)
          r === n
            ? (e[r].setAttribute('class', 'active'), (a[r].active = !0), a[r].panel.removeAttribute('hidden'))
            : (e[r].setAttribute('class', ''), (a[r].active = !1), a[r].panel.setAttribute('hidden', 'true'));
      }
    },
  };
})();
