!(function (e) {
  ...
  function (e, t, n) {
    ...
    function a() {
      ...
      t.initCustomEvent('webviewerloaded', !0, !0, {}), document.dispatchEvent(t), i.PDFViewerApplication.run(e);
    }
    (i = n(1)),
      (r = n(6)),
      n(36),
  ...
  function (e, t, n) {
    ...
    var O,
      V = {
                      ...
                      case 8:
                        return (
                          this.isViewerEmbedded &&
                            o.AppOptions.get('externalLinkTarget') === s.LinkTarget.NONE &&
                            o.AppOptions.set('externalLinkTarget', s.LinkTarget.TOP),
                          (e.next = 11),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 2:
                        return (e.prev = 2), (e.next = 5), this.preferences.getAll();
                      case 5:
                      ...
                      case 9:
                        (e.prev = 9),
                          (e.t0 = e.catch(2)),
                          console.error('_readPreferences: "'.concat(e.t0.message, '".'));
                      case 12:
                      case 'end':
                        return e.stop();
                    }
                      ...
                      case 2:
                        if (
                          ...
                          'disableworker' in (i = (0, a.parseQueryString)(n)) &&
                            ...
                            t.push(F()),
                          'disablerange' in i && o.AppOptions.set('disableRange', 'true' === i.disablerange),
                          'disablestream' in i && o.AppOptions.set('disableStream', 'true' === i.disablestream),
                          'disableautofetch' in i &&
                            o.AppOptions.set('disableAutoFetch', 'true' === i.disableautofetch),
                          'disablefontface' in i && o.AppOptions.set('disableFontFace', 'true' === i.disablefontface),
                          'disablehistory' in i && o.AppOptions.set('disableHistory', 'true' === i.disablehistory),
                          'webgl' in i && o.AppOptions.set('enableWebGL', 'true' === i.webgl),
                          'useonlycsszoom' in i && o.AppOptions.set('useOnlyCssZoom', 'true' === i.useonlycsszoom),
                          'verbosity' in i && o.AppOptions.set('verbosity', 0 | i.verbosity),
                          !('textlayer' in i))
                        ) {
                          e.next = 23;
                          break;
                        ...
                        break;
                      case 18:
                        return o.AppOptions.set('textLayerMode', a.TextLayerMode.DISABLE), e.abrupt('break', 23);
                      case 20:
                        return (
                          this.appConfig.viewerContainer.classList.add('textLayer-' + i.textlayer),
                          e.abrupt('break', 23)
                        );
                      case 23:
                        return (
                          'pdfbug' in i && (o.AppOptions.set('pdfBug', !0), (s = i.pdfbug.split(',')), t.push(U(s))),
                          'locale' in i && o.AppOptions.set('locale', i.locale),
                          e.abrupt(
                            'return',
                            Promise.all(t).catch(function (e) {
                              console.error('_parseHashParameters: "'.concat(e.message, '".'));
                            })
                          )
                        );
                      case 26:
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (this.l10n = this.externalServices.createL10n({ locale: o.AppOptions.get('locale') })),
                          (e.next = 3),
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        (t = this.appConfig),
                          ...
                          (n = t.eventBus || (0, a.getGlobalEventBus)(o.AppOptions.get('eventBusDispatchToDOM'))),
                          (this.eventBus = n),
                          ((i = new l.PDFRenderingQueue()).onIdle = this.cleanup.bind(this)),
                          ...
                          (L = this.externalServices.createDownloadManager({
                            disableCreateObjectURL: o.AppOptions.get('disableCreateObjectURL'),
                          })),
                          (this.downloadManager = L),
                          (C = new g.PDFFindController({ linkService: s, eventBus: n })),
                          ...
                          (this.pdfViewer = new S.PDFViewer({
                            ...
                            renderInteractiveForms: o.AppOptions.get('renderInteractiveForms'),
                          ...
                          (this.pdfHistory = new m.PDFHistory({ linkService: s, eventBus: n })),
                          s.setHistory(this.pdfHistory),
                          (this.findBar = new v.PDFFindBar(t.findBar, n, this.l10n)),
                          ...
                          (this.toolbar = new E.Toolbar(t.toolbar, n, this.l10n)),
                          (this.secondaryToolbar = new k.SecondaryToolbar(t.secondaryToolbar, T, n)),
                          ...
                          (this.pdfSidebarResizer = new _.PDFSidebarResizer(t.sidebarResizer, n, this.l10n));
                      case 34:
                      case 'end':
                        return e.stop();
                    }
        ...
        zoomIn: function (e) {
          ...
          do {
            (t = (1.1 * t).toFixed(2)), (t = Math.ceil(10 * t) / 10), (t = Math.min(a.MAX_SCALE, t));
        ...
        zoomOut: function (e) {
          var t = this.pdfViewer.currentScale;
          do {
            (t = (t / 1.1).toFixed(2)), (t = Math.floor(10 * t) / 10), (t = Math.max(a.MIN_SCALE, t));
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          (this.appConfig.errorWrapper.container.setAttribute('hidden', 'true'), this.pdfLoadingTask)
                        ) {
                          e.next = 4;
                          break;
                        }
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 3:
                        for (a in (i = o.AppOptions.getAll(o.OptionKind.WORKER))) s.GlobalWorkerOptions[a] = i[a];
                        for (c in ((u = Object.create(null)),
                        'string' == typeof t
                          ? (this.setTitleUsingUrl(t), (u.url = t))
                          : t && 'byteLength' in t
                          ? (u.data = t)
                          : t.url && t.originalUrl && (this.setTitleUsingUrl(t.originalUrl), (u.url = t.url)),
                        (l = o.AppOptions.getAll(o.OptionKind.API))))
                          u[c] = l[c];
                        if (n)
                          for (d in n) 'length' === d && this.pdfDocumentProperties.setFileSize(n[d]), (u[d] = n[d]);
                        return (
                          (h = (0, s.getDocument)(u)),
                              ...
                              function (e) {
                                ...
                                t =
                                  e instanceof s.InvalidPDFException
                                    ? f.l10n.get('invalid_file_error', null, 'Invalid or corrupted PDF file.')
                                    : e instanceof s.MissingPDFException
                                    ? f.l10n.get('missing_file_error', null, 'Missing PDF file.')
                                    : e instanceof s.UnexpectedResponseException
                                    ? f.l10n.get('unexpected_response_error', null, 'Unexpected server response.')
                                    : f.l10n.get('loading_error', null, 'An error occurred while loading the PDF.');
                                let i = {};
                                return (
                                  (i.message = n),
        ...
        download: function () {
          ...
          var n = this.baseUrl,
            i = this.contentDispositionFilename || (0, a.getPDFFileNameFromURL)(this.url),
        ...
        error: function (e, t) {
          ...
          t &&
            (n.push(this.l10n.get('error_message', { message: t.message }, 'Message: {{message}}')),
            t.stack
              ? n.push(this.l10n.get('error_stack', { stack: t.stack }, 'Stack: {{stack}}'))
              : (t.filename && n.push(this.l10n.get('error_file', { file: t.filename }, 'File: {{file}}')),
                t.lineNumber && n.push(this.l10n.get('error_line', { line: t.lineNumber }, 'Line: {{line}}')))),
            t.errorMessage &&
              (t.errorOverride ? ((n.length = 0), n.push(t.errorMessage)) : (t.errorAppend, n.push(t.errorMessage)));
          ...
          (l.onclick = function () {
            ...
            (c.onclick = function () {
              u.setAttribute('hidden', 'true'), l.removeAttribute('hidden'), c.setAttribute('hidden', 'true');
            }),
          ...
          v.setDocument(e),
                              ...
                              case 0:
                                return (
                                  ...
                                  l.page &&
                                    g !== B &&
                                    ((y =
                                      'page='.concat(l.page, '&zoom=').concat(w || l.zoom, ',') +
                                      ''.concat(l.scrollLeft, ',').concat(l.scrollTop)),
                                    (b = parseInt(l.rotation, 10)),
                                    _ === c.SidebarView.UNKNOWN && (_ = 0 | l.sidebarView),
                                    P === a.ScrollMode.UNKNOWN && (P = 0 | l.scrollMode),
                                    S === a.SpreadMode.UNKNOWN && (S = 0 | l.spreadMode)),
                                  p && _ === c.SidebarView.UNKNOWN && (_ = Ne(p)),
                                  h && S === a.SpreadMode.UNKNOWN && (S = xe(h)),
                                  t.setInitialView(y, { rotation: b, sidebarView: _, scrollMode: P, spreadMode: S }),
                                  t.eventBus.dispatch('documentinit', { source: t }),
              ...
              if (n && !o.AppOptions.get('disablePageLabels')) {
                ...
                if (r === t.pagesCount) {
                  ...
                  i !== r &&
                    ...
                    t.toolbar.setPageNumber(d.currentPageNumber, d.currentPageLabel));
            ...
            e.getMetadata().then(function (n) {
              ...
              !i && r && r.Title && (i = r.Title),
                i ? t.setTitle(''.concat(i, ' - ').concat(u || document.title)) : u && t.setTitle(u),
                r.IsAcroFormPresent &&
                  (console.warn('Warning: AcroForm/XFA is not supported'), t.fallback(s.UNSUPPORTED_FEATURES.forms));
            });
        },
        ...
        setInitialView: function (e) {
          ...
          (this.isInitialViewSet = !0),
            ...
            this.pdfViewer.currentScaleValue || (this.pdfViewer.currentScaleValue = a.DEFAULT_SCALE_VALUE);
        },
        cleanup: function () {
          this.pdfDocument &&
            (this.pdfViewer.cleanup(),
            this.pdfThumbnailViewer.cleanup(),
            this.pdfViewer.renderer !== a.RendererType.SVG && this.pdfDocument.cleanup());
        },
        ...
        beforePrint: function () {
          ...
          if (t) {
            'true' == window.getUrlParameterByName('beforePrint') &&
              window.parent.postMessage({ viewerId: t, event: 'beforePrint' }, '*');
          }
            ...
            if (this.supportsPrinting)
              if (this.pdfViewer.pageViewsReady) {
                var n = this.pdfViewer.getPagesOverview(),
                  ...
                  r = Be.instance.createPrintService(this.pdfDocument, n, i, this.l10n);
        ...
        afterPrint: function () {
          ...
          e &&
            ...
            window.parent.postMessage({ viewerId: e, event: 'afterPrint' }, '*');
        ...
        bindWindowEvents: function () {
          ...
          (t.windowResize = function () {
            ...
            (t.windowHashChange = function () {
              e.dispatch('hashchange', { source: window, hash: document.location.hash.substring(1) });
            }),
    ...
    function F() {
      return (
        s.GlobalWorkerOptions.workerSrc || (s.GlobalWorkerOptions.workerSrc = o.AppOptions.get('workerSrc')),
    ...
    function U(e) {
      ...
      return (0, s.loadScript)(t.debuggerScriptPath).then(function () {
        PDFBug.enable(e), PDFBug.init({ OPS: s.OPS, createObjectURL: s.createObjectURL }, t.mainContainer);
      });
    }
    function z() {
      var e,
      ...
      (r.id = t.openFileInputName),
        ...
        r.addEventListener('change', function (e) {
          ...
          t && 0 !== t.length && V.eventBus.dispatch('fileinputchange', { source: this, fileInput: e.target });
        }),
        ...
        t.mainContainer.addEventListener('drop', function (e) {
          ...
          t && 0 !== t.length && V.eventBus.dispatch('fileinputchange', { source: this, fileInput: e.dataTransfer });
        }),
        V.supportsPrinting ||
          (t.toolbar.print.classList.add('hidden'), t.secondaryToolbar.printButton.classList.add('hidden')),
      ...
      try {
        ...
        V.l10n.get('loading_error', null, 'An error occurred while loading the PDF.').then(function (t) {
    ...
    function H(e) {
      ...
      if ((t === V.page && V.toolbar.updateLoadingIndicatorState(!1), i)) {
        if (V.pdfSidebar.isThumbnailViewVisible) V.pdfThumbnailViewer.getThumbnail(n).setImage(i);
        'undefined' != typeof Stats && Stats.enabled && i.stats && Stats.add(t, i.stats),
          i.error &&
            V.l10n.get('rendering_error', null, 'An error occurred while rendering the page.').then(function (e) {
              V.error(e, i.error);
            });
      }
    }
    ...
    function K(e) {
      V.pdfRenderingQueue.isThumbnailViewEnabled = V.pdfSidebar.isThumbnailViewVisible;
      var t = V.store;
      t && V.isInitialViewSet && t.set('sidebarView', e.view).catch(function () {});
    }
    function Q(e) {
      var t = e.location,
        n = V.store;
      ...
      (V.appConfig.toolbar.viewBookmark.href = i), (V.appConfig.secondaryToolbar.viewBookmarkButton.href = i);
      var r = V.pdfViewer.getPageView(V.page - 1).renderingState !== l.RenderingStates.FINISHED;
      V.toolbar.updateLoadingIndicatorState(r);
    }
    function Z(e) {
      var t = V.store;
      t && V.isInitialViewSet && t.set('scrollMode', e.mode).catch(function () {});
    }
    function X(e) {
      var t = V.store;
      t && V.isInitialViewSet && t.set('spreadMode', e.mode).catch(function () {});
    }
    function Y() {
      var e = V.pdfDocument,
        t = V.pdfViewer;
    ...
    function J(e) {
      var t = e.hash;
      t &&
        (V.isInitialViewSet ? V.pdfHistory.popStateInProgress || V.pdfLinkService.setHash(t) : (V.initialBookmark = t));
    }
    function $() {
    ...
    function ye(e) {
      ...
      V.supportsIntegratedFind ? V.externalServices.updateFindMatchesCount(t) : V.findBar.updateResultsCount(t);
    }
    function be(e) {
      var t = e.state,
        n = e.previous,
      ...
      V.supportsIntegratedFind
        ? V.externalServices.updateFindControlState({ result: t, findPrevious: n, matchesCount: i })
    ...
    function Se(e) {
      ...
      if (
        ...
        V.pdfSidebar.isThumbnailViewVisible && V.pdfThumbnailViewer.scrollThumbnailIntoView(t),
      ...
      if (i) {
        'true' == window.getUrlParameterByName('pageChange') &&
          window.parent.postMessage({ viewerId: i, event: 'pageChange', param: t }, '*');
      }
    }
    function ke(e) {
    ...
    (O = function (e) {
      if (void 0 !== e)
        try {
          ...
          var i = e && e.message;
          throw (
            (V.l10n.get('loading_error', null, 'An error occurred while loading the PDF.').then(function (e) {
              let t = {};
              (t.message = i), window.setCustomError(t), V.error(e, { message: i });
            }),
            e)
          );
        }
      ...
      (D = function (e) {
        if (!V.pdfViewer || !V.pdfViewer.isInPresentationMode) {
          ...
          if (s.URL.createObjectURL && !o.AppOptions.get('disableCreateObjectURL')) {
          ...
          r.toolbar.viewBookmark.setAttribute('hidden', 'true'),
            r.secondaryToolbar.viewBookmarkButton.setAttribute('hidden', 'true'),
    ...
    function Te(e) {
      if (V.secondaryToolbar.isOpen) {
        ...
        (V.pdfViewer.containsElement(e.target) ||
          (t.toolbar.container.contains(e.target) && e.target !== t.secondaryToolbar.toggleButton)) &&
    ...
    function Ie(e) {
      if (!V.overlayManager.active) {
        ...
        if (1 === i || 8 === i || 5 === i || 12 === i)
          switch (e.keyCode) {
            ...
            case 38:
              ...
              break;
            case 40:
              (a || V.page < V.pagesCount) && ((V.page = V.pagesCount), (t = !0), (n = !0));
          }
        if (1 === i || 8 === i)
          switch (e.keyCode) {
            case 83:
        ...
        if (('INPUT' !== l && 'TEXTAREA' !== l && 'SELECT' !== l) || 27 === e.keyCode) {
          if (0 === i) {
            ...
            switch (e.keyCode) {
              ...
              case 80:
                ...
                break;
              case 27:
                V.secondaryToolbar.isOpen && (V.secondaryToolbar.close(), (t = !0)),
                  !V.supportsIntegratedFind && V.findBar.opened && (V.findBar.close(), (t = !0));
                break;
              case 40:
              case 34:
                r.isVerticalScrollbarEnabled && (d = !0), (c = 1);
            ...
            0 === c ||
              ...
              (c > 0 ? V.page < V.pagesCount && V.page++ : V.page > 1 && V.page--, (t = !0));
          }
          if (4 === i)
            switch (e.keyCode) {
              case 13:
          ...
          t || a || (((e.keyCode >= 33 && e.keyCode <= 40) || (32 === e.keyCode && 'BUTTON' !== l)) && (n = !0)),
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (t.isValidScrollMode = function (e) {
        return Number.isInteger(e) && Object.values(d).includes(e) && e !== d.UNKNOWN;
      }),
      ...
      (t.getPDFFileNameFromURL = function (e) {
        ...
        if (t) return t;
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'document.pdf';
        ...
        if (
          ...
          return console.warn('getPDFFileNameFromURL: ignoring "data:" URL for performance reasons.'), n;
        var i = /[^\/?#=]+\.pdf\b(?!.*\.pdf\b)/i,
          r = /^(?:(?:[^:]+:)?\/\/[^\/]+)?([^?#]*)(\?[^#]*)?(#.*)?$/.exec(e),
      ...
      (t.approximateFraction = function (e) {
        ...
        n = i - r / a < o / s - i ? (i === e ? [r, a] : [a, r]) : i === e ? [o, s] : [s, o];
        return n;
      }),
      ...
      (t.scrollIntoView = function (e, t) {
        ...
        for (
          ...
          if (
            (i.dataset._scaleY && ((r /= i.dataset._scaleY), (a /= i.dataset._scaleX)),
            (r += i.offsetTop),
            (a += i.offsetLeft),
            !(i = i.offsetParent))
          )
            return;
        t && (void 0 !== t.top && (r += t.top), void 0 !== t.left && ((a += t.left), (i.scrollLeft = a)));
        i.scrollTop = r;
      }),
      (t.watchScroll = function (e, t) {
        var n = function (n) {
          ...
          i = { right: !0, down: !0, lastX: e.scrollLeft, lastY: e.scrollTop, _eventHandler: n },
          r = null;
      ...
      (t.waitOnEventOrTimeout = function (e) {
        ...
        return new Promise(function (e, i) {
          if ('object' !== u(t) || !n || 'string' != typeof n || !(Number.isInteger(r) && r >= 0))
            throw new Error('waitOnEventOrTimeout - invalid parameters.');
          function a(i) {
            t instanceof y ? t.off(n, o) : t.removeEventListener(n, o), l && clearTimeout(l), e(i);
          }
    ...
    var y = (function () {
      function e() {
        var t = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).dispatchToDOM,
          n = void 0 !== t && t;
        a(this, e), (this._listeners = Object.create(null)), (this._dispatchToDOM = !0 === n);
      }
      return (
        s(e, [
          {
          ...
          },
          {
            ...
            set: function (e) {
              ...
              (this._indeterminate = isNaN(e)),
                (this._percent = ((t = e), (n = 0), (i = 100), Math.min(Math.max(t, n), i))),
                this._updateBar();
            },
          },
        ]),
  ...
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.OptionKind = t.AppOptions = void 0);
    var i = n(7),
      r = n(8);
    function a(e) {
      return (a =
    ...
    var u = {
      ...
      defaultUrl: { value: 'compressed.tracemonkey-pldi-09.pdf', kind: s.VIEWER },
    ...
    (u.disablePreferences = { value: !1, kind: s.VIEWER }),
      (u.locale = { value: 'undefined' != typeof navigator ? navigator.language : 'en-US', kind: s.VIEWER });
                ...
                for (var n in u) {
                  ...
                  if (e) {
                    ...
                    if (e === s.PREFERENCE) {
                      var r = i.value,
                        o = a(r);
                      if ('boolean' === o || 'string' === o || ('number' === o && Number.isInteger(r))) {
                        t[n] = r;
                        continue;
                      }
                      throw new Error('Invalid type for preference: '.concat(n));
                    }
                  }
                  var c = l[n];
    ...
    (window.getUrlParameterByName = function (e, t) {
      ...
      (window.setCustomError = function (e) {
        ...
        if (t) {
          window.getUrlParameterByName('errorOverride') && ((e.errorOverride = !0), (e.errorMessage = t)),
            window.getUrlParameterByName('errorAppend') && ((e.errorAppend = !0), (e.errorMessage = t));
        }
      }),
      (window.applyUserDefaults = function (e) {
        let t = window.getUrlParameterByName('locale');
        t && e.set('locale', t), window.getUrlParameterByName('useOnlyCssZoom') && e.set('useOnlyCssZoom', !0);
      }),
      (window.applyParameterOverride = function (e) {
        'false' === window.getUrlParameterByName('openFile') &&
          ...
          'false' === window.getUrlParameterByName('viewBookmark') &&
            ...
            e.secondaryToolbar.viewBookmarkButton.setAttribute('hidden', 'true')),
          'false' === window.getUrlParameterByName('print') &&
            (e.toolbar.print.classList.add('hidden'), e.secondaryToolbar.printButton.classList.add('hidden')),
          ...
          'false' === window.getUrlParameterByName('find') && e.toolbar.viewFind.classList.add('hidden');
      }),
            ...
            value: function (e) {
              ...
              if (null === this.activeBeforePresentationMode && e !== this.active) {
                ...
                switch (e) {
                  ...
                  case a.ZOOM:
                  default:
                    return void console.error('switchTool: "'.concat(e, '" is an unsupported value.'));
                }
            ...
            value: function () {
              ...
              this.eventBus.on('switchcursortool', function (t) {
                ...
                this.eventBus.on('presentationmodechanged', function (t) {
                  ...
                  t.switchInProgress ||
                    (t.active
                      ? ((n = e.active), e.switchTool(a.SELECT), (e.activeBeforePresentationMode = n))
  ...
  function (e, t, n) {
    ...
    var o = { UNKNOWN: -1, NONE: 0, THUMBS: 1, OUTLINE: 2, ATTACHMENTS: 3, LAYERS: 4 };
    t.SidebarView = o;
    var s = (function () {
      function e(t) {
        var n = t.elements,
          ...
          },
          {
            ...
            value: function () {
              ...
              this.isInitialViewSet ||
                ((this.isInitialViewSet = !0),
                (e !== o.NONE && e !== o.UNKNOWN && this._switchView(e, !0)) || this._dispatchEvent());
            },
          },
          {
            key: 'switchView',
            ...
            value: function (e) {
              ...
              switch (e) {
                ...
                case o.ATTACHMENTS:
                  ...
                  break;
                default:
                  return console.error('PDFSidebar._switchView: "'.concat(e, '" is not a valid view.')), !1;
              }
              return (
                (this.active = e),
                this.thumbnailButton.classList.toggle('toggled', e === o.THUMBS),
                this.outlineButton.classList.toggle('toggled', e === o.OUTLINE),
                this.attachmentsButton.classList.toggle('toggled', e === o.ATTACHMENTS),
                this.thumbnailView.classList.toggle('hidden', e !== o.THUMBS),
                this.outlineView.classList.toggle('hidden', e !== o.OUTLINE),
                this.attachmentsView.classList.toggle('hidden', e !== o.ATTACHMENTS),
                t && !this.isOpen
                  ? (this.open(), !0)
                  : (i && (this._updateThumbnailViewer(), this._forceRendering()),
          ...
          },
          {
            ...
            value: function () {
              for (var e = this.pdfViewer, t = this.pdfThumbnailViewer, n = e.pagesCount, i = 0; i < n; i++) {
                ...
                if (a && a.renderingState === r.RenderingStates.FINISHED) t.getThumbnail(i).setImage(a);
              }
              ...
              this.viewerContainer.addEventListener('transitionend', function (t) {
                ...
                this.eventBus.on('outlineloaded', function (t) {
                  ...
                  (e.outlineButton.disabled = !n),
                    n ? e._showUINotification(o.OUTLINE) : e.active === o.OUTLINE && e.switchView(o.THUMBS);
                }),
                this.eventBus.on('attachmentsloaded', function (t) {
                  if (t.attachmentsCount)
                    return (e.attachmentsButton.disabled = !1), void e._showUINotification(o.ATTACHMENTS);
                  Promise.resolve().then(function () {
                    e.attachmentsView.hasChildNodes() ||
                      ((e.attachmentsButton.disabled = !0), e.active === o.ATTACHMENTS && e.switchView(o.THUMBS));
                  });
                }),
                this.eventBus.on('presentationmodechanged', function (t) {
  ...
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.OverlayManager = void 0);
    var i,
      r = (i = n(2)) && i.__esModule ? i : { default: i };
      ...
      return (
        ...
        (n = [
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            if (
                              ((i = s.length > 2 && void 0 !== s[2] ? s[2] : null),
                          ...
                          case 8:
                            this._overlays[t] = { element: n, container: o, callerCloseMethod: i, canForceClose: a };
                          case 9:
                          case 'end':
                            return e.stop();
                        }
          ...
          },
          {
            ...
            value: function () {
              this._overlays[this._active].callerCloseMethod && this._overlays[this._active].callerCloseMethod(),
              ...
              this.overlayManager.open(this.overlayName).then(function () {
                e.input.focus(),
                  (e.reason === r.PasswordResponses.INCORRECT_PASSWORD
                    ? e.l10n.get('password_invalid', null, 'Invalid password. Please try again.')
                    : e.l10n.get('password_label', null, 'Enter the password to open this PDF file.')
                  ).then(function (t) {
        ...
        (n = [
          {
            ...
            value: function () {
              ...
              (this.attachments = null),
                ...
                e || (this._renderedCapability = (0, i.createPromiseCapability)());
            },
          },
          {
            key: '_dispatchEvent',
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if ((this.attachments && this.reset(!0 === r), (this.attachments = t || null), t)) {
                ...
                for (var s = 0; s < a; s++) {
                  var u = t[o[s]],
                    l = (0, i.removeNullCharacters)((0, i.getFilenameFromUrl)(u.filename)),
                    c = document.createElement('div');
                  c.className = 'attachmentsItem';
                  var d = document.createElement('button');
                  (d.textContent = l),
                    /\.pdf$/i.test(l) && !this.downloadManager.disableCreateObjectURL
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this._renderedCapability.promise.then(function () {
                ...
                (e[n] = { filename: i, content: r }), t.render({ attachments: e, keepRenderedCapability: !0 });
              });
            },
          },
        ]) && r(t.prototype, n),
    ...
    var v = (function () {
      function e(t, n, i) {
        var r = this,
          ...
          u = t.container,
          l = t.closeButton,
          c = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : o.NullL10n;
        !(function (e, t) {
          if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
        })(this, e),
          (this.overlayName = a),
              ...
              Promise.all([this.overlayManager.open(this.overlayName), this._dataAvailableCapability.promise]).then(
                function () {
                  var n = e._currentPageNumber,
                    i = e._pagesRotation;
                  e.fieldData && n === e.fieldData._currentPageNumber && i === e.fieldData._pagesRotation
                    ? e._updateUI()
                    : e.pdfDocument
                        .getMetadata()
                        .then(function (t) {
                          ...
                          return Promise.all([
                            ...
                            e.pdfDocument.getPage(n).then(function (t) {
                              return e._parsePageSize((0, o.getPageSizeInches)(t), i);
                            }),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.pdfDocument && (this._reset(), this._updateUI(!0)),
                e && ((this.pdfDocument = e), (this.url = t), this._dataAvailableCapability.resolve());
            },
          },
          {
            key: 'setFileSize',
          ...
          },
          {
            ...
            value: function () {
              (this.pdfDocument = null),
                ...
                (this._dataAvailableCapability = (0, a.createPromiseCapability)()),
                  ...
                  return r.default.wrap(
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            if (((t = i.length > 0 && void 0 !== i[0] ? i[0] : 0), (n = t / 1024))) {
                              e.next = 6;
                              break;
                            }
                            return e.abrupt('return', void 0);
                          case 6:
                            ...
                            return e.abrupt(
                              ...
                              this.l10n.get(
                                ...
                                { size_kb: (+n.toPrecision(3)).toLocaleString(), size_b: t.toLocaleString() },
                          ...
                          case 8:
                            return e.abrupt(
                              ...
                              this.l10n.get(
                                ...
                                { size_mb: (+(n / 1024).toPrecision(3)).toLocaleString(), size_b: t.toLocaleString() },
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 2:
                            return (
                              n % 180 != 0 && (t = { width: t.height, height: t.width }),
                              ...
                              (c = p(a, i, h) || p(s, i, f)) ||
                                ...
                                ((d = { width: 25.4 * t.width, height: 25.4 * t.height }),
                                (v = { width: Math.round(s.width), height: Math.round(s.height) }),
                                Math.abs(d.width - v.width) < 0.1 &&
                                  Math.abs(d.height - v.height) < 0.1 &&
                                  (c = p(v, i, f)) &&
                                  ((a = {
                                    width: Math.round((v.width / 25.4) * 100) / 100,
                                    height: Math.round((v.height / 25.4) * 100) / 100,
                                  }),
                                  (s = v))),
                              c &&
                                (u = this.l10n.get('document_properties_page_size_name_' + c.toLowerCase(), null, c)),
                              e.abrupt(
                                'return',
                                Promise.all([
                                  ...
                                  var t = l(e, 4),
                                    ...
                                    s = t[3];
                                  return g.l10n.get(
                                    'document_properties_page_size_dimension_' + (o ? 'name_' : '') + 'string',
                                    {
                                    ...
                                    '{{width}} × {{height}} {{unit}} (' + (o ? '{{name}}, ' : '') + '{{orientation}})'
                                  );
                                })
                              )
                            );
                          ...
                          case 3:
                            return e.abrupt(
                              ...
                              this.l10n.get(
                                ...
                                { date: n.toLocaleDateString(), time: n.toLocaleTimeString() },
                                '{{date}}, {{time}}'
                              )
                            );
                          case 4:
  ...
  function (e, t, n) {
    ...
    var o = (function () {
      function e(t) {
        var n = this,
          r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : (0, i.getGlobalEventBus)(),
          a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : i.NullL10n;
        !(function (e, t) {
          if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
        })(this, e),
      ...
      return (
        ...
        (n = [
            ...
            value: function (e, t, n) {
              ...
              switch (e) {
                ...
                case r.FindState.WRAPPED:
                  o = t
                    ? this.l10n.get('find_reached_top', null, 'Reached top of document, continued from bottom')
                    : this.l10n.get('find_reached_bottom', null, 'Reached end of document, continued from top');
              }
            ...
            value: function () {
              ...
              if (this.findResultsCount) {
                ...
                a > 0 &&
                  (o =
                    a > 1e3
                      ? this.l10n.get('find_match_count_limit', { limit: 1e3 }, 'More than {{limit}} matches')
                      : this.l10n.get(
                          'find_match_count',
                          { current: i, total: a },
                          '{{current}} of {{total}} match' + (1 !== a ? 'es' : '')
                        )),
          ...
          },
          {
            ...
            value: function () {
              this.opened ||
                ((this.opened = !0), this.toggleButton.classList.add('toggled'), this.bar.classList.remove('hidden')),
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (t) {
                ...
                (null === this._state || this._shouldDirtyMatch(e, t)) && (this._dirtyMatch = !0),
                  (this._state = t),
                  'findhighlightallchange' !== e && this._updateUIState(s.PENDING),
                  this._firstPageCapability.promise.then(function () {
                    if (n._pdfDocument && (!i || n._pdfDocument === i)) {
                      n._extractText();
                      var t = !n._highlightMatches,
                        r = !!n._findTimeout;
                      n._findTimeout && (clearTimeout(n._findTimeout), (n._findTimeout = null)),
                        'find' === e
                          ...
                          ? n._nextMatch()
                          : 'findagain' === e
                          ? (n._nextMatch(), t && n._state.highlightAll && n._updateAllPages())
                          : 'findhighlightallchange' === e
                          ? (r ? n._nextMatch() : (n._highlightMatches = !0), n._updateAllPages())
                          : n._nextMatch();
                    }
                  });
              }
              ...
              switch (e) {
                case 'findagain':
                  var n = this._selected.pageIdx + 1,
                    i = this._linkService;
                  if (n >= 1 && n <= i.pagesCount && i.page !== n && i.isPageVisible && !i.isPageVisible(n)) break;
                  return !1;
          ...
          },
          {
            ...
            value: function (e, t, n, i) {
              for (var r = [], a = e.length, o = -a; -1 !== (o = n.indexOf(e, o + a)); )
          ...
          },
          {
            ...
            value: function (e, t, n, i) {
              for (var r = [], a = e.match(/\S+/g), o = 0, s = a.length; o < s; o++)
                for (var u = a[o], l = u.length, c = -l; -1 !== (c = n.indexOf(u, c + l)); )
                  (i && !this._isEntireWord(n, c, l)) || r.push({ match: c, matchLength: l, skipped: !1 });
              (this._pageMatchesLength[t] = []),
                (this._pageMatches[t] = []),
                this._prepareMatches(r, this._pageMatches[t], this._pageMatchesLength[t]);
            },
          },
          {
            key: '_calculateMatch',
            value: function (e) {
              ...
              if (0 !== n.length) {
                r || ((t = t.toLowerCase()), (n = n.toLowerCase())),
                  o ? this._calculatePhraseMatch(n, e, t, a) : this._calculateWordMatch(n, e, t, a),
                  this._state.highlightAll && this._updatePage(e),
                  this._resumePageIdx === e && ((this._resumePageIdx = null), this._nextPageMatch());
                          ...
                          return e._pdfDocument
                            ...
                            .then(
                              function (t) {
                                ...
                                (e._pageContents[n] = c(r.join(''))), a.resolve(n);
                              },
                              function (t) {
                                console.error('Unable to get text content for page '.concat(n + 1), t),
                                  (e._pageContents[n] = ''),
                                  a.resolve(n);
                              }
                            );
                ...
                if (!this._resumePageIdx) {
                  ...
                  if (((this._pagesToSearch = i), null !== a.matchIdx)) {
                    ...
                    if ((!t && a.matchIdx + 1 < o) || (t && a.matchIdx > 0))
                      return (a.matchIdx = t ? a.matchIdx - 1 : a.matchIdx + 1), void this._updateMatch(!0);
            ...
            value: function (e) {
              ...
              return n
                ...
                : (this._advanceOffsetPage(i),
                  !!(t.wrapped && ((t.matchIdx = null), this._pagesToSearch < 0)) && (this._updateMatch(!1), !0));
            },
          },
          {
            key: '_nextPageMatch',
            ...
            value: function () {
              ...
              if (((this._offset.wrapped = !1), e)) {
                ...
                (this._selected.pageIdx = this._offset.pageIdx),
                  ...
                  -1 !== i && i !== this._selected.pageIdx && this._updatePage(i);
              }
              this._updateUIState(t, this._state.findPrevious),
                -1 !== this._selected.pageIdx && ((this._scrollMatches = !0), this._updatePage(this._selected.pageIdx));
            },
          },
          {
            key: '_onFindBarClose',
            value: function (e) {
              ...
              this._firstPageCapability.promise.then(function () {
                !t._pdfDocument ||
                  (n && t._pdfDocument !== n) ||
                  (t._findTimeout && (clearTimeout(t._findTimeout), (t._findTimeout = null)),
                  t._resumePageIdx && ((t._resumePageIdx = null), (t._dirtyMatch = !0)),
            ...
            get: function () {
              return (
                this._state.query !== this._rawQuery &&
                  ((this._rawQuery = this._state.query), (this._normalizedQuery = c(this._state.query))),
  ...
  function (e, t, n) {
    ...
    function u(e) {
      ...
      return (
        (Number.isInteger(n) && n > 0 && n <= e.pagesCount) || (n = null), { hash: t, page: n, rotation: e.rotation }
      );
    }
    var l = (function () {
      function e(t) {
        ...
        !(function (e, t) {
          ...
          (this.applyActionsOverride = function () {
            ...
            window.getUrlParameterByName('startDownload') && n.eventBus.dispatch('download', { source: n }),
              window.getUrlParameterByName('startPrint') && n.eventBus.dispatch('print', { source: n }),
              window.getUrlParameterByName('lastpage') && n.eventBus.dispatch('lastpage', { source: n }),
              window.getUrlParameterByName('rotatecw') && n.eventBus.dispatch('rotatecw', { source: n }),
              window.getUrlParameterByName('rotateccw') && n.eventBus.dispatch('rotateccw', { source: n });
          }),
          this.eventBus.on('pagesloaded', function (e) {
            ...
            if (t) {
              'true' == window.getUrlParameterByName('pagesLoaded') &&
                window.parent.postMessage({ viewerId: t, event: 'pagesLoaded', param: e.pagesCount }, '*');
            }
          });
      }
      var t, n, l;
        ...
        (n = [
          {
            ...
            value: function (e) {
              ...
              if (t && 'string' == typeof t) {
                ...
                (this.fingerprint = t), (this._updateUrl = !0 === a), this.initialized || this._bindEvents();
                ...
                if (
                  ...
                  return !d || o || i
                    ...
                    : void this._pushOrReplaceState({ hash: d, page: h, rotation: f }, !0);
                }
                var p = l.destination;
                this._updateInternalState(p, l.uid, !0),
                  ...
                  p.dest
                    ? ((this.initialBookmark = JSON.stringify(p.dest)), (this._destination.page = null))
                    : p.hash
            ...
            value: function (e) {
              ...
              if (this.initialized)
                if (i && 'string' != typeof i)
                  ...
                  if (
                    (Number.isInteger(a) && a > 0 && a <= this.linkService.pagesCount) ||
                    (null === a && !this._destination)
                  ) {
                    var o = i || JSON.stringify(r);
                    if (o) {
                      var s = !1;
                      if (this._destination && (c(this._destination.hash, o) || d(this._destination.dest, r))) {
                        if (this._destination.page) return;
                        s = !0;
                      }
                      (this._popStateInProgress && !s) ||
                        (this._pushOrReplaceState(
                          { dest: r, hash: o, page: a, rotation: this.linkService.rotation },
                          s
                        ),
                  ...
                  } else console.error('PDFHistory.push: ' + '"'.concat(a, '" is not a valid pageNumber parameter.'));
                else console.error('PDFHistory.push: ' + '"'.concat(r, '" is not a valid explicitDest parameter.'));
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              var t,
                n = (arguments.length > 1 && void 0 !== arguments[1] && arguments[1]) || !this._destination,
                i = { fingerprint: this.fingerprint, uid: n ? this._uid : this._uid + 1, destination: e };
              if ((this._updateInternalState(e, i.uid), this._updateUrl && e && e.hash)) {
                var r = document.location.href.split('#')[0];
                r.startsWith('file://') || (t = ''.concat(r, '#').concat(e.hash));
              }
              n
                ? t
                ...
                : ((this._maxUid = this._uid),
                  t ? window.history.pushState(i, '', t) : window.history.pushState(i, ''));
            },
          },
          {
            ...
            value: function () {
              ...
              if (this._position) {
                ...
                if (
                  (e && ((t = Object.assign(Object.create(null), this._position)).temporary = !0), this._destination)
                ) {
                  if (this._destination.temporary) this._pushOrReplaceState(t, !0);
                  else if (
                    this._destination.hash !== t.hash &&
                    (this._destination.page || !(this._numPositionUpdates <= 50))
                  ) {
                    var n = !1;
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (e.fingerprint !== this.fingerprint) {
                if (!t) return !1;
                if ('string' != typeof e.fingerprint || e.fingerprint.length !== this.fingerprint.length) return !1;
                var n = a(performance.getEntriesByType('navigation'), 1)[0];
                if (!n || 'reload' !== n.type) return !1;
              }
              return (
                !(!Number.isInteger(e.uid) || e.uid < 0) && null !== e.destination && 'object' === r(e.destination)
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this._updateViewareaTimeout &&
                (clearTimeout(this._updateViewareaTimeout), (this._updateViewareaTimeout = null)),
                (this._position = {
                  hash: this._isViewerInPresentationMode ? 'page='.concat(n.pageNumber) : n.pdfOpenParams.substring(1),
                ...
                if (this._isValidState(n)) {
                  (this._popStateInProgress = !0),
                    a &&
                      ...
                      (0, i.waitOnEventOrTimeout)({ target: window, name: 'hashchange', delay: 1e3 }).then(function () {
                        t._blockHashChange--;
                      }));
                  var o = n.destination;
                  this._updateInternalState(o, n.uid, !0),
                    this._uid > this._maxUid && (this._maxUid = this._uid),
                    (0, i.isValidRotation)(o.rotation) && (this.linkService.rotation = o.rotation),
                    o.dest
    ...
    function c(e, t) {
      return 'string' == typeof e && 'string' == typeof t && (e === t || (0, i.parseQueryString)(e).nameddest === t);
    }
    function d(e, t) {
      function n(e, t) {
        if (r(e) !== r(t)) return !1;
  ...
  function (e, t, n) {
                      ...
                      if (s instanceof Object) {
                        if (null === (r = t._cachedPageNumber(s)))
                          return void t.pdfDocument
                            .getPageIndex(s)
                            .then(function (e) {
                              t.cachePageRef(e + 1, s), n({ namedDest: a, explicitDest: o });
                            })
                            .catch(function () {
                              console.error(
                                'PDFLinkService.navigateTo: "'.concat(s, '" is not ') +
                                  'a valid page reference, for dest="'.concat(e, '".')
                              );
                            });
                      } else {
                        if (!Number.isInteger(s))
                          return void console.error(
                            'PDFLinkService.navigateTo: "'.concat(s, '" is not ') +
                              'a valid destination reference, for dest="'.concat(e, '".')
                          );
                        r = s + 1;
                      }
                      !r || r < 1 || r > t.pagesCount
                        ? console.error(
                            'PDFLinkService.navigateTo: "'.concat(r, '" is not ') +
                              'a valid page number, for dest="'.concat(e, '".')
                          )
                        : (t.pdfHistory &&
                            (t.pdfHistory.pushCurrentPosition(),
                            t.pdfHistory.push({ namedDest: a, explicitDest: o, pageNumber: r })),
                          t.pdfViewer.scrollPageIntoView({ pageNumber: r, destArray: o }));
                    })(n)
                  : console.error(
                      'PDFLinkService.navigateTo: "'.concat(n.explicitDest, '" is') +
                        ' not a valid destination array, for dest="'.concat(e, '".')
                    );
              });
            },
          },
              ...
              if (e.includes('=')) {
                ...
                if (('page' in a && (t = 0 | a.page || 1), 'zoom' in a)) {
                  ...
                  s.includes('Fit')
                    ? 'Fit' === s || 'FitB' === s
                      ? (n = [null, { name: s }])
                      : 'FitH' === s || 'FitBH' === s || 'FitV' === s || 'FitBV' === s
                      ? (n = [null, { name: s }, o.length > 1 ? 0 | o[1] : null])
                      : 'FitR' === s
                      ? 5 !== o.length
                        ? console.error('PDFLinkService.setHash: Not enough parameters for "FitR".')
                        : (n = [null, { name: s }, 0 | o[1], 0 | o[2], 0 | o[3], 0 | o[4]])
                      : console.error('PDFLinkService.setHash: "'.concat(s, '" is not ') + 'a valid zoom value.')
                    : (n = [
                        null,
                        { name: 'XYZ' },
                ...
                n
                  ...
                  : t && (this.page = t),
                  'pagemode' in a && this.eventBus.dispatch('pagemode', { source: this, mode: a.pagemode });
              } else {
                n = unescape(e);
                try {
                ...
                if (
                  ...
                  (function (e) {
                    ...
                    if (
                      !(
                        ('object' === r(i) && Number.isInteger(i.num) && Number.isInteger(i.gen)) ||
                        (Number.isInteger(i) && i >= 0)
                      )
                    )
                      return !1;
                    var a = e[1];
                    if ('object' !== r(a) || 'string' != typeof a.name) return !1;
                    switch (a.name) {
                      case 'XYZ':
                        if (5 !== t) return !1;
                        break;
                ...
                console.error('PDFLinkService.setHash: "'.concat(unescape(e), '" is not ') + 'a valid destination.');
              }
            },
          },
          {
    ...
    var l = (function () {
      function e() {
        a(this, e), (this.externalLinkTarget = null), (this.externalLinkRel = null);
      }
      return (
        s(e, [
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              try {
                for (
                  var a, o = e.querySelectorAll('.outlineItemToggler')[Symbol.iterator]();
                  !(n = (a = o.next()).done);
                  n = !0
                ) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if ((this.outline && this.reset(), (this.outline = t || null), t)) {
                for (
                  var r = document.createDocumentFragment(), a = [{ parent: r, items: this.outline }], o = !1;
                  a.length > 0;
                  ...
                  for (var s = a.shift(), u = 0, l = s.items.length; u < l; u++) {
                    ...
                    if (
                      (this._bindLink(h, c),
                      this._setStyles(h, c),
                      (h.textContent = (0, i.removeNullCharacters)(c.title) || '–'),
                      d.appendChild(h),
                      c.items.length > 0)
                    ) {
                      (o = !0), this._addToggleButton(d);
                      var f = document.createElement('div');
                      (f.className = 'outlineItems'), d.appendChild(f), a.push({ parent: f, items: c.items });
                    }
          ...
          !(function (e, t) {
            ...
            l &&
              (l.contextFirstPage.addEventListener('click', function () {
                (n.contextMenuOpen = !1), n.eventBus.dispatch('firstpage', { source: n });
              }),
              l.contextLastPage.addEventListener('click', function () {
                (n.contextMenuOpen = !1), n.eventBus.dispatch('lastpage', { source: n });
              }),
              l.contextPageRotateCw.addEventListener('click', function () {
                (n.contextMenuOpen = !1), n.eventBus.dispatch('rotatecw', { source: n });
              }),
              l.contextPageRotateCcw.addEventListener('click', function () {
                (n.contextMenuOpen = !1), n.eventBus.dispatch('rotateccw', { source: n });
              }));
        }
        var t, n, o;
        return (
          ...
          (n = [
              ...
              value: function (e) {
                ...
                0 === e.button &&
                  ((e.target.href && e.target.classList.contains('internalLink')) ||
                    (e.preventDefault(), e.shiftKey ? this._goToPreviousPage() : this._goToNextPage()));
              },
            },
            {
              key: '_contextMenu',
            ...
            },
            {
              ...
              value: function () {
                this.controlsTimeout &&
                  (clearTimeout(this.controlsTimeout),
                  this.container.classList.remove('pdfPresentationModeControls'),
                    ...
                    switch (e.type) {
                      ...
                      case 'touchend':
                        ...
                        Math.abs(n) > 50 && (r <= a || r >= Math.PI - a)
                          ? (t = n)
                          : Math.abs(i) > 50 && Math.abs(r - Math.PI / 2) <= a && (t = i),
                          t > 0 ? this._goToPreviousPage() : t < 0 && this._goToNextPage();
                    }
              },
            },
            {
  ...
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.PDFSidebarResizer = void 0);
    var i = n(5);
    function r(e, t) {
      for (var n = 0; n < t.length; n++) {
        var i = t[n];
    ...
    var a = '--sidebar-width',
      ...
      s = (function () {
        function e(t, n) {
          var r = this,
            s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : i.NullL10n;
          !(function (e, t) {
            if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
          })(this, e),
            (this.enabled = !1),
          ...
          (n = [
            {
              ...
              value: function () {
                ...
                return (
                  e > t && (e = t),
                  e < o && (e = o),
                  e !== this._width && ((this._width = e), this.doc.style.setProperty(a, ''.concat(e, 'px')), !0)
                );
              },
            },
            {
                    ...
                    this.eventBus.on('resize', function (t) {
                      if (t && t.source === window && ((e._outerContainerWidth = null), e._width))
                        if (e.sidebarOpen) {
                          ...
                          Promise.resolve().then(function () {
                            e.outerContainer.classList.remove('sidebarResizing'),
            ...
            },
            {
              ...
              get: function () {
                return (
                  this._outerContainerWidth || (this._outerContainerWidth = this.outerContainer.clientWidth),
    ...
    var o = (function () {
      function e(t) {
        ...
        !(function (e, t) {
          ...
          (this.l10n = s),
          (this.scroll = (0, i.watchScroll)(this.container, this._scrollUpdated.bind(this))),
          this._resetView();
      }
      var t, n, o;
      return (
              ...
              if (this.pdfDocument) {
                ...
                if (t) {
                  if (e !== this._currentPageNumber)
                    this._thumbnails[this._currentPageNumber - 1].div.classList.remove('selected'),
              ...
              this.pdfDocument && (this._cancelRendering(), this._resetView()),
                ...
                e &&
                  e
                    .getPage(1)
                    .then(function (n) {
                      for (var i = e.numPages, a = n.getViewport({ scale: 1 }), o = 1; o <= i; ++o) {
      ...
      d = (function () {
        function e(t) {
          ...
          (v.href = s.getAnchorUrl('#page=' + i)),
            this.l10n.get('thumb_page_title', { page: i }, 'Page {{page}}').then(function (e) {
              v.title = e;
            }),
            (v.onclick = function () {
              return (s.page = i), !1;
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              key: 'cancelRendering',
              value: function () {
                this.renderTask && (this.renderTask.cancel(), (this.renderTask = null)), (this.resume = null);
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (this.renderingState !== a.RenderingStates.INITIAL)
                  return console.error('Must be in new state before drawing'), Promise.resolve(void 0);
            ...
            },
            {
              ...
              value: function (e) {
                if (this.renderingState === a.RenderingStates.INITIAL) {
                  var t = e.canvas;
                  if (t) {
                    this.pdfPage || this.setPdfPage(e.pdfPage), (this.renderingState = a.RenderingStates.FINISHED);
                    var n = this._getPageDrawContext(!0),
                      i = n.canvas;
                    if (t.width <= 2 * i.width)
                      return (
                        n.drawImage(t, 0, 0, t.width, t.height, 0, 0, i.width, i.height),
                        void this._convertCanvasToImage()
                      );
                    for (
                      var r = i.width << 3, o = i.height << 3, s = c.getCanvas(r, o), u = s.getContext('2d');
                      r > t.width || o > t.height;

                    )
                      (r >>= 1), (o >>= 1);
                    for (u.drawImage(t, 0, 0, t.width, t.height, 0, 0, r, o); r > 2 * i.width; )
                      u.drawImage(s, 0, 0, r, o, 0, 0, r >> 1, o >> 1), (r >>= 1), (o >>= 1);
                    n.drawImage(s, 0, 0, r, o, 0, 0, i.width, i.height), this._convertCanvasToImage();
                  }
                }
              },
            },
            {
              ...
              value: function (e) {
                ...
                (this.pageLabel = 'string' == typeof e ? e : null),
                  this.l10n.get('thumb_page_title', { page: this.pageId }, 'Page {{page}}').then(function (e) {
                    t.anchor.title = e;
                  }),
                    ...
                    this.l10n
                      ...
                      .then(function (e) {
                        t.image
                          ...
                          : t.disableCanvasToImageConversion && t.canvas && t.canvas.setAttribute('aria-label', e);
                      });
              },
            },
            {
      ...
      return (
        ...
        (a = [
            ...
            value: function (e) {
              ...
              if (!r && !this.isInPresentationMode) {
                var s = n.offsetLeft + n.clientLeft,
                  ...
                  h = d.scrollLeft,
                  f = d.clientWidth;
                (this._isScrollModeHorizontal || s < h || c > h + f) && (r = { left: 0, top: 0 });
              }
              u(l(t.prototype), '_scrollIntoView', this).call(this, { pageDiv: n, pageSpot: r, pageNumber: o });
            },
          },
          {
          ...
          },
          {
            ...
            get: function () {
              return (0, r.shadow)(this, '_setDocumentViewerElement', this.viewer);
            },
          },
        ]) && o(n.prototype, a),
        d && o(n, d),
    ...
    function d(e) {
      ...
      (this.push = function (n) {
        ...
        (this.resize = function (n, r) {
          if (((e = n), r)) {
            for (var a = new Set(), o = 0, s = r.length; o < s; ++o) a.add(r[o].id);
    ...
    var h = (function () {
      function e(t) {
        ...
        (this._name = this.constructor.name),
          ...
          (this.textLayerMode = Number.isInteger(t.textLayerMode) ? t.textLayerMode : i.TextLayerMode.ENABLE),
          ...
          this.defaultRenderingQueue
            ? ((this.renderingQueue = new r.PDFRenderingQueue()), this.renderingQueue.setViewer(this))
            : (this.renderingQueue = t.renderingQueue),
          (this.scroll = (0, i.watchScroll)(this.container, this._scrollUpdate.bind(this))),
        ...
        (n = [
              ...
              if (
                ...
                (this.pagesPromise = r.promise),
                  r.promise.then(function () {
                    (t._pageViewsReady = !0), t.eventBus.dispatch('pagesloaded', { source: t, pagesCount: n });
                  });
                ...
                (this.firstPagePromise = l),
                  l
                    .then(function (o) {
                      for (var l = t.currentScale, c = o.getViewport({ scale: l * i.CSS_UNITS }), d = 1; d <= n; ++d) {
                        var h = null;
                      ...
                      t._spreadMode !== i.SpreadMode.NONE && t._updateSpreadMode(),
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if (
                ...
                i && this.eventBus.dispatch('scalechanging', { source: this, scale: e, presetValue: t });
              else {
                ...
                if (((this._currentScale = e), !n)) {
                  ...
                  !this._location ||
                    ...
                    (o = [null, { name: 'XYZ' }, this._location.left, this._location.top, null])),
                    this.scrollPageIntoView({ pageNumber: s, destArray: o, allowNegativeOffset: !0 });
                }
                this.eventBus.dispatch('scalechanging', { source: this, scale: e, presetValue: i ? t : void 0 }),
              ...
              if (n > 0) this._setScaleUpdatePages(n, e, t, !1);
                ...
                switch (e) {
                  ...
                  case 'page-fit':
                    ...
                    break;
                  case 'auto':
                    var d = (0, i.isPortraitOrientation)(r) ? l : Math.min(c, l);
                    n = Math.min(i.MAX_AUTO_SCALE, d);
                    break;
                  default:
                    return void console.error(
                      ''.concat(this._name, '._setScale: "').concat(e, '" is an unknown zoom value.')
                    );
                }
              ...
              if (this.pdfDocument) {
                ...
                if (s)
                  if (!this.isInPresentationMode && r) {
                    ...
                    switch (r[1].name) {
                      case 'XYZ':
                        (c = r[2]), (d = r[3]), (m = r[4]), (c = null !== c ? c : 0), (d = null !== d ? d : g);
                        break;
                      case 'Fit':
                      case 'FitB':
                        m = 'page-fit';
                      ...
                      case 'FitBH':
                        (m = 'page-width'),
                          null === (d = r[2]) &&
                            this._location &&
                            ((c = this._location.left), (d = this._location.top));
                        break;
                      case 'FitV':
                      case 'FitBV':
                      ...
                      case 'FitR':
                        ...
                        var w = this.removePageBorders ? 0 : i.SCROLLBAR_PADDING,
                          y = this.removePageBorders ? 0 : i.VERTICAL_PADDING;
                        (u = (this.container.clientWidth - w) / h / i.CSS_UNITS),
                          (l = (this.container.clientHeight - y) / f / i.CSS_UNITS),
                          (m = Math.min(Math.abs(u), Math.abs(l)));
                        break;
                      default:
                        return void console.error(
                          ''.concat(this._name, '.scrollPageIntoView: ') +
                            '"'.concat(r[1].name, '" is not a valid destination type.')
                        );
                    }
                    if (
                      (m && m !== this._currentScale
                        ? (this.currentScaleValue = m)
                        : this._currentScale === i.UNKNOWN_SCALE && (this.currentScaleValue = i.DEFAULT_SCALE_VALUE),
                      'page-fit' !== m || r[4])
                    ) {
                      var b = [
                      ...
                      o || ((_ = Math.max(_, 0)), (P = Math.max(P, 0))),
                        this._scrollIntoView({ pageDiv: s.div, pageSpot: { left: _, top: P }, pageNumber: t });
                    } else this._scrollIntoView({ pageDiv: s.div, pageNumber: t });
          ...
          },
          {
            ...
            value: function () {
              ...
              var e = this._pages[this._currentPageNumber - 1],
                t = e.div,
                n = { id: e.id, x: t.offsetLeft + t.clientLeft, y: t.offsetTop + t.clientTop, view: e };
          ...
          },
          {
            key: '_getVisiblePages',
            value: function () {
              return (0, i.getVisibleElements)(this.container, this._pages, !0, this._isScrollModeHorizontal);
            },
          },
          {
            key: 'isPageVisible',
            value: function (e) {
              return (
                ...
                (this.pageNumber < 1 || e > this.pagesCount
                  ? (console.error(''.concat(this._name, '.isPageVisible: "').concat(e, '" is out of bounds.')), !1)
          ...
          },
          {
            ...
            value: function (e, t) {
              var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : '',
                ...
                o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : i.NullL10n;
            ...
            value: function () {
              ...
              return e.map(function (e) {
                return t === (0, i.isPortraitOrientation)(e)
                  ? e
                  : { width: e.height, height: e.width, rotation: (e.rotation + 90) % 360 };
              });
            },
          },
          {
            ...
            value: function () {
              var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                t = this._scrollMode,
                n = this.viewer;
              n.classList.toggle('scrollHorizontal', t === i.ScrollMode.HORIZONTAL),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (this.pdfDocument) {
                var t = this.viewer,
                  n = this._pages;
                if (((t.textContent = ''), this._spreadMode === i.SpreadMode.NONE))
                  for (var r = 0, a = n.length; r < a; ++r) t.appendChild(n[r].div);
                else
                  for (var o = this._spreadMode - 1, s = null, u = 0, l = n.length; u < l; ++u)
                    null === s
                      ? (((s = document.createElement('div')).className = 'spread'), t.appendChild(s))
                      : u % 2 === o && ((s = s.cloneNode(!1)), t.appendChild(s)),
          ...
          },
          {
            ...
            set: function (e) {
              ...
              this.pdfDocument &&
                (this._setCurrentPageNumber(e, !0) ||
                  console.error(''.concat(this._name, '.currentPageNumber: "').concat(e, '" is not a valid page.')));
            },
          },
          {
            ...
            set: function (e) {
              if (this.pdfDocument) {
                ...
                this._setCurrentPageNumber(t, !0) ||
                  console.error(''.concat(this._name, '.currentPageLabel: "').concat(e, '" is not a valid page.'));
              }
            },
          },
          {
            key: 'currentScale',
            get: function () {
              return this._currentScale !== i.UNKNOWN_SCALE ? this._currentScale : i.DEFAULT_SCALE;
            },
            set: function (e) {
          ...
          },
          {
            ...
            set: function (e) {
              if (!(0, i.isValidRotation)(e)) throw new Error('Invalid pages rotation angle.');
              if (this.pdfDocument && this._pagesRotation !== e) {
                this._pagesRotation = e;
          ...
          },
          {
            ...
            get: function () {
              return !this.isInPresentationMode && this._scrollMode === i.ScrollMode.HORIZONTAL;
            },
          },
          {
            key: 'isInPresentationMode',
            get: function () {
              return this.presentationModeState === i.PresentationModeState.FULLSCREEN;
            },
          },
          {
            key: 'isChangingPresentationMode',
            get: function () {
              return this.presentationModeState === i.PresentationModeState.CHANGING;
            },
          },
          {
          ...
          },
          {
            ...
            set: function (e) {
              if (this._scrollMode !== e) {
                if (!(0, i.isValidScrollMode)(e)) throw new Error('Invalid scroll mode: '.concat(e));
                (this._scrollMode = e),
          ...
          },
          {
            ...
            set: function (e) {
              if (this._spreadMode !== e) {
                if (!(0, i.isValidSpreadMode)(e)) throw new Error('Invalid spread mode: '.concat(e));
                (this._spreadMode = e),
        ...
        u(e, [
          {
            ...
            value: function (e, t) {
              var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : '',
                i = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
                o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : r.NullL10n;
              return new l({
                pageDiv: e,
                pdfPage: t,
                imageResourcesPath: n,
      ...
      d = (function () {
        function e(t) {
          ...
          (this.id = t.id),
            ...
            (this.textLayerMode = Number.isInteger(t.textLayerMode) ? t.textLayerMode : a.TextLayerMode.ENABLE),
            (this.imageResourcesPath = t.imageResourcesPath || ''),
            (this.renderInteractiveForms = t.renderInteractiveForms || !1),
            (this.useOnlyCssZoom = t.useOnlyCssZoom || !1),
          ...
          (n = [
            {
              ...
              value: function (e) {
                (this.pdfPage = e), (this.pdfPageRotate = e.rotate);
                var t = (this.rotation + this.pdfPageRotate) % 360;
                (this.viewport = e.getViewport({ scale: this.scale * a.CSS_UNITS, rotation: t })),
                  (this.stats = e.stats),
                  this.reset();
              },
            },
            ...
            },
            {
              ...
              value: function () {
                ...
                this.cancelRendering(t), (this.renderingState = s.RenderingStates.INITIAL);
                var n = this.div;
                ...
                for (
                  var i = n.childNodes,
                    ...
                    a = (t && this.annotationLayer && this.annotationLayer.div) || null,
                    o = i.length - 1;
                  o >= 0;
                  o--
                ) {
                ...
                n.removeAttribute('data-loaded'),
                  a
                    ...
                    : this.annotationLayer && (this.annotationLayer.cancel(), (this.annotationLayer = null)),
                  r ||
                    (this.canvas &&
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                if (((this.viewport = this.viewport.clone({ scale: this.scale * a.CSS_UNITS, rotation: n })), this.svg))
                  return (
                    this.cssTransform(this.svg, !0),
                    void this.eventBus.dispatch('pagerendered', { source: this, pageNumber: this.id, cssTransform: !0 })
                  );
                var i = !1;
                if (this.canvas && this.maxCanvasPixels > 0) {
                  var r = this.outputScale;
                  ((Math.floor(this.viewport.width) * r.sx) | 0) * ((Math.floor(this.viewport.height) * r.sy) | 0) >
                ...
                if (this.canvas) {
                  ...
                  this.zoomLayer ||
                    ...
                    ((this.zoomLayer = this.canvas.parentNode), (this.zoomLayer.style.position = 'absolute'));
                }
            ...
            },
            {
              ...
              value: function () {
                ...
                this.paintTask && (this.paintTask.cancel(), (this.paintTask = null)),
                  ...
                  !e && this.annotationLayer && (this.annotationLayer.cancel(), (this.annotationLayer = null));
              },
            },
            {
              key: 'cssTransform',
              value: function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                  ...
                  r = this.div;
                (e.style.width = e.parentNode.style.width = r.style.width = Math.floor(n) + 'px'),
                  (e.style.height = e.parentNode.style.height = r.style.height = Math.floor(i) + 'px');
                ...
                if (((e.style.transform = l), this.textLayer)) {
                  ...
                  (g.style.transform =
                    'rotate(' + h + 'deg) scale(' + f + ', ' + f + ') translate(' + p + ', ' + v + ')'),
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  return (
                    (this.renderingState = s.RenderingStates.FINISHED), Promise.reject(new Error('Page is not loaded'))
                  );
                ...
                (i.style.width = n.style.width),
                  ...
                  this.annotationLayer && this.annotationLayer.div
                    ...
                    : n.appendChild(i);
                var l = null;
                if (this.textLayerMode !== a.TextLayerMode.DISABLE && this.textLayerFactory) {
                ...
                var h = (function () {
                          ...
                          return r.default.wrap(function (i) {
                            for (;;)
                              switch ((i.prev = i.next)) {
                                ...
                                case 4:
                                  if (
                                    ((e.renderingState = s.RenderingStates.FINISHED),
                                    e.loadingIconDiv && (n.removeChild(e.loadingIconDiv), delete e.loadingIconDiv),
                                    e._resetZoomLayer(!0),
                                    (e.error = a),
                                    (e.stats = t.stats),
                  ...
                  f = this.renderer === a.RendererType.SVG ? this.paintOnSvg(i) : this.paintOnCanvas(i);
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (this.maxCanvasPixels > 0) {
                  ...
                  c.sx > f || c.sy > f
                    ? ((c.sx = f), (c.sy = f), (c.scaled = !0), (this.hasRestrictedScaling = !0))
                    : (this.hasRestrictedScaling = !1);
                }
                ...
                (r.width = (0, a.roundToDivide)(i.width * c.sx, p[0])),
                  ...
                  (r.style.height = (0, a.roundToDivide)(i.height, v[1]) + 'px'),
            ...
            },
            {
              ...
              value: function (e) {
                var t = this,
                  n = !1,
                  i = function () {
                    if (n) throw new o.RenderingCancelledException('Rendering cancelled, page ' + t.id, 'svg');
                  },
                  r = this.pdfPage,
                ...
                return {
                  promise: r.getOperatorList().then(function (n) {
                    return (
                      i(),
                      new o.SVGGraphics(r.commonObjs, r.objs).getSVG(n, u).then(function (n) {
                        i(),
                          (t.svg = n),
              ...
              if ((this.textContent || this.textContentStream) && !this.renderingDone) {
                ...
                (this.textLayerRenderTask = (0, r.renderTextLayer)({
                  ...
                  this.textLayerRenderTask.promise.then(
                    function () {
                      e.textLayerDiv.appendChild(n), e._finishRendering(), e._updateMatches();
                    },
                    function (e) {}
                  ),
                  this._onUpdateTextLayerMatches ||
                    ((this._onUpdateTextLayerMatches = function (t) {
                      (t.pageIndex !== e.pageIdx && -1 !== t.pageIndex) || e._updateMatches();
                    }),
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              for (
                ...
                for (var d = e[l]; r !== o && d >= a + i[r].length; ) (a += i[r].length), r++;
                r === i.length && console.error('Could not find a matching mapping');
                var h = { begin: { divIdx: r, offset: d - a } };
                for (d += t ? t[l] : s; r !== o && d > a + i[r].length; ) (a += i[r].length), r++;
              ...
              if (0 !== e.length) {
                ...
                for (var d = l; d < c; d++) {
                  var h = e[d],
                    ...
                    g = v ? ' selected' : '';
                  if (
                    (v && t.scrollMatchIntoView({ element: r[f.divIdx], pageIndex: n, matchIndex: o }),
                    s && f.divIdx === s.divIdx
                    ...
                    for (var m = f.divIdx + 1, w = p.divIdx; m < w; m++) r[m].className = 'highlight middle' + g;
                    y(p, 'highlight end' + g);
                  }
                  s = p;
                }
            ...
            value: function () {
              if (this.renderingDone) {
                for (
                  ...
                  for (var u = t[o], l = Math.max(a, u.begin.divIdx), c = u.end.divIdx; l <= c; l++) {
                    var d = r[l];
                ...
                if (e && e.highlightMatches) {
                  ...
                  (this.matches = this._convertMatches(h, f)), this._renderMatches(this.matches);
                }
              }
            },
          },
            ...
            value: function () {
              ...
              t.addEventListener('mousedown', function (i) {
                if (e.enhanceTextSelection && e.textLayerRenderTask)
                  return e.textLayerRenderTask.expandTextDivs(!0), void (n && (clearTimeout(n), (n = null)));
        ...
        s(e, [
          {
            ...
            value: function (e, t, n) {
              var i = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
              return new u({ textLayerDiv: e, pageIndex: t, viewport: n, enhanceTextSelection: i });
            },
          },
        ]),
        e
    ...
    var s = (function () {
      function e(t, n, o) {
        ...
        !(function (e, t) {
          ...
          (this.buttons = [
            { element: t.presentationModeButton, eventName: 'presentationmode', close: !0 },
            ...
            { element: t.pageRotateCcwButton, eventName: 'rotateccw', close: !1 },
            {
            ...
            { element: t.documentPropertiesButton, eventName: 'documentproperties', close: !0 },
          ]),
          (this.items = {
          ...
          this.eventBus.on('baseviewerinit', function (e) {
            e.source instanceof a.PDFSinglePageViewer
              ? s.toolbarButtonContainer.classList.add('hiddenScrollModeButtons', 'hiddenSpreadModeButtons')
              : s.toolbarButtonContainer.classList.remove('hiddenScrollModeButtons', 'hiddenSpreadModeButtons');
          });
      }
      var t, n, s;
      return (
        ...
        (n = [
          ...
          },
          {
            ...
            value: function (e) {
              this.eventBus.on('cursortoolchanged', function (t) {
                var n = t.tool;
                e.cursorSelectToolButton.classList.toggle('toggled', n === r.CursorTool.SELECT),
                  e.cursorHandToolButton.classList.toggle('toggled', n === r.CursorTool.HAND);
              });
            },
          },
          {
            ...
            value: function (e) {
              ...
              function n(t) {
                var n = t.mode;
                e.scrollVerticalButton.classList.toggle('toggled', n === i.ScrollMode.VERTICAL),
                  e.scrollHorizontalButton.classList.toggle('toggled', n === i.ScrollMode.HORIZONTAL),
                  e.scrollWrappedButton.classList.toggle('toggled', n === i.ScrollMode.WRAPPED);
                var r = n === i.ScrollMode.HORIZONTAL;
                (e.spreadNoneButton.disabled = r), (e.spreadOddButton.disabled = r), (e.spreadEvenButton.disabled = r);
              }
          ...
          },
          {
            ...
            value: function (e) {
              ...
              function n(t) {
                var n = t.mode;
                e.spreadNoneButton.classList.toggle('toggled', n === i.SpreadMode.NONE),
                  e.spreadOddButton.classList.toggle('toggled', n === i.SpreadMode.ODD),
                  e.spreadEvenButton.classList.toggle('toggled', n === i.SpreadMode.EVEN);
              }
              ...
              this.opened &&
                ...
                this.containerHeight !== this.previousContainerHeight &&
                  (this.toolbarButtonContainer.setAttribute(
                    'style',
                    'max-height: ' + (this.containerHeight - i.SCROLLBAR_PADDING) + 'px;'
                  ),
  ...
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.PDFSinglePageViewer = void 0);
    var i = n(28),
      r = n(7);
    function a(e) {
      return (a =
    ...
    var d = (function (e) {
      function t(e) {
        ...
        return (
          ...
          (n = s(this, l(t).call(this, e))).eventBus.on('pagesinit', function (e) {
      ...
      return (
        ...
        (a = [
          ...
          },
          {
            key: '_scrollUpdate',
            value: function () {
              this._updateScrollDown && this._updateScrollDown(), u(l(t.prototype), '_scrollUpdate', this).call(this);
            },
          },
          {
            key: '_scrollIntoView',
            value: function (e) {
              ...
              this._ensurePageViewVisible(),
                this.update(),
                u(l(t.prototype), '_scrollIntoView', this).call(this, { pageDiv: i, pageSpot: a, pageNumber: s }),
          ...
          { key: '_updateSpreadMode', value: function () {} },
          {
            key: '_setDocumentViewerElement',
            get: function () {
              return (0, r.shadow)(this, '_setDocumentViewerElement', this._shadowViewer);
            },
          },
          {
            key: '_isScrollModeHorizontal',
  ...
  function (e, t, n) {
    ...
    var a = (function () {
      function e(t, n) {
        var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : i.NullL10n;
        !(function (e, t) {
          if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
        })(this, e),
            ...
            value: function () {
              ...
              if (this._wasLocalized) {
                ...
                e &&
                  (this.hasPageLabels
                    ...
                    : ((o.pageNumber.type = 'number'),
                      this.l10n.get('of_pages', { pagesCount: n }, 'of {{pagesCount}}').then(function (e) {
                  ...
                  this.hasPageLabels
                    ? ((o.pageNumber.value = this.pageLabel),
                      this.l10n
                        .get('page_of_pages', { pageNumber: t, pagesCount: n }, '({{pageNumber}} of {{pagesCount}})')
                        .then(function (e) {
                          o.numPages.textContent = e;
                        }))
                ...
                this.l10n.get('page_scale_percent', { scale: s }, '{{scale}}%').then(function (e) {
                  for (var t = o.scaleSelect.options, n = !1, i = 0, a = t.length; i < a; i++) {
                    var s = t[i];
                    s.value === r ? ((s.selected = !0), (n = !0)) : (s.selected = !1);
                  }
              ...
              i.animationStarted.then(function () {
                if ((0 === e.clientWidth && e.setAttribute('style', 'display: inherit;'), e.clientWidth > 0)) {
                  ...
                  t.setAttribute('style', 'min-width: ' + (n + 22) + 'px;'),
                    e.setAttribute('style', 'min-width: ' + n + 'px; max-width: ' + n + 'px;');
                }
              });
            },
          },
        ...
        function e(t) {
          ...
          !(function (e, t) {
            ...
            (this._initializedPromise = this._readFromStorage().then(function (e) {
              var t = JSON.parse(e || '{}');
              if ('files' in t) for (; t.files.length >= n.cacheSize; ) t.files.shift();
              else t.files = [];
              ...
              -1 === i && (i = t.files.push({ fingerprint: n.fingerprint }) - 1),
                (n.file = t.files[i]),
                (n.database = t);
            }));
        }
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 2:
                              for (i in ((n = Object.create(null)), t))
                                (a = this.file[i]), (n[i] = void 0 !== a ? a : t[i]);
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 2:
                            return (
                              ...
                              e.abrupt('return', this._writeToStorage(this.defaults))
                            );
                          case 4:
                          case 'end':
                            return e.stop();
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 2:
                            ...
                            throw new Error('Set preference: "'.concat(t, '" is undefined.'));
                          case 7:
                            if (void 0 !== n) {
                              e.next = 9;
                              break;
                          ...
                          case 16:
                            throw new Error(
                              'Set preference: "'.concat(n, '" is a ').concat(a, ', ') + 'expected a '.concat(o, '.')
                            );
                          case 17:
                            e.next = 21;
                            break;
                          case 19:
                            ...
                            throw new Error('Set preference: "'.concat(n, '" must be an integer.'));
                          case 21:
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 2:
                            ...
                            throw new Error('Get preference: "'.concat(t, '" is undefined.'));
                          case 7:
        ...
        (n = [
          {
            key: 'downloadUrl',
            value: function (e, t) {
              (0, i.createValidAbsoluteUrl)(e, 'http://example.com') && o(e + '#pdfjs.action=download', t);
            },
          },
          {
            key: 'downloadData',
            value: function (e, t, n) {
              navigator.msSaveBlob
                ...
                : o((0, i.createObjectURL)(e, n, this.disableCreateObjectURL), t);
            },
          },
          {
            key: 'download',
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            case 0:
                              return (e.next = 2), this._ready;
                            case 2:
                              return (a = e.sent), e.abrupt('return', a.get(t, n, i));
                            case 4:
                            case 'end':
                              return e.stop();
                          }
              ...
              (function (e, n) {
                ...
                for (var t in e) {
                  var r,
                    o,
                    s = t.lastIndexOf('.');
                  s > 0 ? ((r = t.substring(0, s)), (o = t.substring(s + 1))) : ((r = t), (o = a)),
                    i[r] || (i[r] = {}),
                    (i[r][o] = e[t]);
                }
                n && n();
      ...
      function g(e, t, n) {
        return e.replace(/\{\{\s*(.+?)\s*\}\}/g, function (e, r) {
          return t && r in t
            ...
            : r in i
            ? i[r]
            : (console.log('argument {{' + r + '}} for #' + n + ' is undefined.'), e);
        });
      }
      function m(e) {
        var n = (function (e) {
          ...
          if (i) {
            if (i[a]) {
              if (
                ...
                for (var r = e.childNodes, o = !1, s = 0, u = r.length; s < u; s++)
                  3 === r[s].nodeType &&
                    /\S/.test(r[s].nodeValue) &&
                    (o ? (r[s].nodeValue = '') : ((r[s].nodeValue = i[a]), (o = !0)));
                if (!o) {
            ...
            (s._pluralRules = (function (e) {
              ...
              var i = {
                  ...
                  13: function (e) {
                    return n(e % 10, 2, 4) && !n(e % 100, 12, 14)
                      ? 'few'
                      : (1 != e && n(e % 10, 0, 1)) || n(e % 10, 5, 9) || n(e % 100, 12, 14)
                      ? 'many'
                      : 1 == e
                      ? 'one'
                      : 'other';
  ...
  function (e, t, n) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.PDFPrintService = u);
    var i = n(5),
      r = n(1),
      a = n(7),
      o = null,
    ...
    u.prototype = {
      layout: function () {
        ...
        e.setAttribute('data-pdfjsprinting', !0),
          ...
          }, this) || console.warn('Not all pages have the same size. The printed result may be incorrect!'),
          (this.pageStyleSheet = document.createElement('style'));
        var t = this.pagesOverview[0];
        (this.pageStyleSheet.textContent =
          '@supports ((size:A4) and (size:1pt 1pt)) {@page { size: ' + t.width + 'pt ' + t.height + 'pt;}}'),
          e.appendChild(this.pageStyleSheet);
      },
      destroy: function () {
        o === this &&
          ((this.printContainer.textContent = ''),
          this.pageStyleSheet && (this.pageStyleSheet.remove(), (this.pageStyleSheet = null)),
                ...
                t
                  ...
                  .then(function (e) {
                    var t = {
                      ...
                      viewport: e.getViewport({ scale: 1, rotation: r.rotation }),
                      intent: 'print',
                    };
    ...
    function h(e, t, n) {
      ...
      (a.value = r),
        n.get('print_progress_percent', { progress: r }, r + '%').then(function (e) {
          o.textContent = e;
        });
    }
      ...
      (window.addEventListener(
        ...
        function (e) {
          if (
            ...
            return (
              e.preventDefault(), void (e.stopImmediatePropagation ? e.stopImmediatePropagation() : e.stopPropagation())
            );
          }
        },
        !0
    ...
    function g() {
      if (!f) {
        ...
        (f = s.register('printServiceOverlay', document.getElementById('printServiceOverlay'), d, !0)),
